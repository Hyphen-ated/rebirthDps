...
$(document).ready(function(e) {
    ...
    $(".button-wrap").on("click", function() {
		...
		if ($('.items-container').hasClass("rebirth")){
			$('.items-container').fadeOut('slow',loadVanilla);
			$('.trinkets-container').fadeOut();
			$('.tarot-container').fadeOut();
		} else {
			$('.items-container').fadeOut('slow',loadRebirth);
			$('.trinkets-container').fadeOut();
			$('.tarot-container').fadeOut();
		}
		
		function loadRebirth() {
			$('.items-container').load("rebirth-items.php",'',showNewContentItems());
			$('.items-container').removeClass("vanilla");
			$('.items-container').addClass("rebirth");	
			
			$('.trinkets-container').load("rebirth-trinkets.php",'',showNewContentTrinkets());
			$('.trinkets-container').removeClass("vanilla");
			$('.trinkets-container').addClass("rebirth");
			
			$('.tarot-container').load("rebirth-cards.php",'',showNewContentCards());
			$('.tarot-container').removeClass("vanilla");
			$('.tarot-container').addClass("rebirth");
		}
		function loadVanilla() {
			$('.items-container').load("items.php",'',showNewContentItems());
			$('.items-container').removeClass("rebirth");
			$('.items-container').addClass("vanilla");
			
			
			$('.trinkets-container').load("trinkets.php",'',showNewContentTrinkets());
			$('.trinkets-container').removeClass("rebirth");
			$('.trinkets-container').addClass("vanilla");
			
			$('.tarot-container').load("cards.php",'',showNewContentCards());
			$('.tarot-container').removeClass("rebirth");
			$('.tarot-container').addClass("vanilla");
			
		}
		function showNewContentItems() {
			$('.items-container').show();
		}
		function showNewContentTrinkets() {
			$('.trinkets-container').show();
		}
		function showNewContentCards() {
			$('.tarot-container').show();
		}
	});
	// options
	...
	$('.items-container.rebirth .textbox').click(function(e){	
		var dat = $(this).data("sid");	
		var markup = findItemFromID(dat);
		markup += '<a class="pp-close" onclick="closepp()">x</a>';
		var node = document.getElementById("popup");
		node.innerHTML = markup;		
		$('.itm-popup').slideDown();
